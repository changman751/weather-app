...
$(".search").on("click", function() {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=" + subject + "&APPID=f8e7426ee7910c7a363cd38cbd9b58f7 ";
    var queryURL2 = "https://api.openweathermap.org/data/2.5/forecast?q=" + subject + "&APPID=f8e7426ee7910c7a363cd38cbd9b58f7 ";
    var lat;
    var lon;
    $(".enterCity").val('');
...
//This first ajax request collects current weather data and converts info into what we want to display.
    $.ajax({
        ...
        queryURL = "http://api.openweathermap.org/data/2.5/uvi/forecast?&appid=f8e7426ee7910c7a363cd38cbd9b58f7&lat=" + lat + "&lon=" + lon;
